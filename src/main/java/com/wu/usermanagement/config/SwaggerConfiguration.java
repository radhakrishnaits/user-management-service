/*
 * package com.wu.usermanagement.config; import
 ...
 * springfox.documentation.service.*; import
 ...
 * 
 * private ApiInfo apiInfo() { return new ApiInfo("Blog REST APIs",
 * "REST APIs for Blog Application", "1.0", "Terms of service", new
 * Contact("Ramesh Fadatare", "www.javaguides.net", "ramesh@gmail.com"),
